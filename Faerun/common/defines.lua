...
NDiplomacy = {
	...
	MAX_LONG_REIGN_BONUS = 20,                 -- Max bonus in opinion you can get from long reign
...
NCharacter = {
	...
	NATURAL_DEATH_CHANCE_AGE_0 = 2,					-- Natural deaths per decade out of 10000 people: Age 0-9
	...
	NATURAL_DEATH_CHANCE_AGE_40 = 45,				-- Natural deaths per decade out of 10000 people: Age 40-49
	NATURAL_DEATH_CHANCE_AGE_50 = 80,				-- Natural deaths per decade out of 10000 people: Age 50-59
	NATURAL_DEATH_CHANCE_AGE_60 = 300,				-- Natural deaths per decade out of 10000 people: Age 60-69
	NATURAL_DEATH_CHANCE_AGE_70 = 1200,				-- Natural deaths per decade out of 10000 people: Age 70-79
	NATURAL_DEATH_CHANCE_AGE_80 = 3100,				-- Natural deaths per decade out of 10000 people: Age 80-90
	...
	FEMALE_ATTRACTION_CUTOFF = 65,					-- After this age, the sex appeal of traits no longer have any effect
...
NReligion = {
	...
	AUTHORITY_FROM_ORG_RELIGION = 0.3,				-- Authority from being an organized religion
...
NMilitary = {
	...
	LOOTED_MODIFIER_MONTHS = 72,					-- How long pagan looting lasts
	LOOT_TAX_MULTIPLIER = 0.75,						-- Base gold looted from raided holdings is (tax * LOOT_TAX_MULTIPLIER) + (total building value * LOOT_BUILDING_MULTIPLIER)
	LOOT_BUILDING_MULTIPLIER = 0.01,				-- Extra gold looted from raided holdings, from buildings (LOOT_BUILDING_MULTIPLIER * building built cost)
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 20,				-- Set this to your earliest starting year
	...
	IDEAL_YEAR_LEVEL_0 = 450, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 1600,
